...
import { StyleSheet, Text, View , TextInput, TouchableOpacity, ToastAndroid, Image, KeyboardAvoidingView, Modal, ScrollView} from 'react-native';
...
export default class LoginScreen extends React.Component{
    ...
    render(){
        return(
            ...
            <View style={{backgroundColor:'#FCE0B1'}}>
        ...
        <View>
               <Image
                ...
                <View style={{alignItems:'center'}}>
                  ...
                  >
                        <Text style={{fontSize:20, color:'orange', fontWeight:'bold', color:'white'}}>SIGN-UP</Text>
